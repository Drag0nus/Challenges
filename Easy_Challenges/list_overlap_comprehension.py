...
random_list1 = set([randint(1, 100) for i in range(randint(5, 35))])
random_list2 = set([randint(1, 100) for j in range(randint(5, 35))])
...
print(overlap(random_list1, random_list2))
...
# I had not yet discussed on the blog,
